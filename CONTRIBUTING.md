...
## We Use [Github Flow](https://guides.github.com/introduction/flow/index.html), So the mostly Code Changes Happen Through Pull Requests
...
## Report bugs using Github's [issues](https://github.com/Qerim-iseni09/ByeLog4Shell/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/Qerim-iseni09/ByeLog4Shell/issues/new/choose); it's that easy!
